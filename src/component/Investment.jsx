...
const Investment = () => {
  ...
  return (
    <div className="min-h-screen bg-[#080C14] text-white px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="rounded-2xl border border-gray-800 bg-[#101620] p-5 sm:p-7">
        ...
        <div className="mb-7">
          ...
          <div className="mt-2 flex flex-wrap items-end gap-3">
            <h2 className="text-3xl sm:text-4xl font-bold">₹{netWorth}</h2>
        ...
        <div className="grid grid-cols-2 gap-4 border-t border-gray-800 pt-6 sm:grid-cols-4">
          {/* Invested */}
          <div>
            <p className="text-xs sm:text-sm text-gray-500">Invested Amount</p>

            <p className="mt-2 text-lg sm:text-xl font-semibold">₹{invested}</p>
          </div>
          ...
          {/* Cash */}
          <div>
            <p className="text-xs sm:text-sm text-gray-500">Available Cash</p>
      ...
      <div className="mt-10">
        <div className="mb-5">
          <h2 className="text-xl sm:text-2xl font-bold">Invest in Stocks</h2>
      ...
      <div className="mt-10">
        <div className="mb-5 flex items-end justify-between">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold">Your Investments</h2>
            ...
            >
              <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div>
                  ...
                  <p className="mt-1 font-semibold">{investment.value}</p>
                </div>
